...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_MESSAGE, binding.inputMessages.getText().toString());
        message.put(Constants.KEY_TIMESTAMP, new Date());
        database.collection(Constants.KEY_COLLECTION_CHAT).add(message);
        if (conversionId != null){
            updateConversion(binding.inputMessages.getText().toString());
        }else {
            ...
            conversion.put(Constants.KEY_LAST_MESSAGE, binding.inputMessages.getText().toString());
        ...
        if(isReceiverAvailable){
            try {
                ...
                data.put(Constants.KEY_MESSAGE, binding.inputMessages.getText().toString());
        ...
        binding.inputMessages.setText(null);
    }
